...
public class Help {
	...
	public void showHelp(TextChannel channel) {
		new MessageBuilder()
			...
			.append("!roll <option><dice>t<target number> ").append("VS Target Number", MessageDecoration.BOLD).appendNewLine()
			.append("!roll <option><dice>v<option><dice> ").append("Opposed Role", MessageDecoration.BOLD).appendNewLine()
			.append("Options Key: ", MessageDecoration.BOLD, MessageDecoration.UNDERLINE).appendNewLine()
			.append("Favored use: F").appendNewLine()
